...
- ## INTRODUCTION    
    ...
    - 학습 모델의 성능을 높히기 위한 조건     
        ...
        [Refer From Here](https://machinelearningmastery.com/improve-deep-learning-performance/)
    ...
    [Refer from Here](https://medium.com/data-science-bootcamp/multilayer-perceptron-mlp-vs-convolutional-neural-network-in-deep-learning-c890f487a8f1)    
...
- ## Section 3. Architecture
    ...
    - ### ReLU Nonlinearity
        ...
        ![ReLUs vs tanh](/public/asset/reluVStanh.jpg)
        [Refer From Here](https://ratsgo.github.io/deep%20learning/2017/04/22/NNtricks/)
        ...
        - #### parallelization scheme (나는 1개 GPU로 구축해서 사용 못함)
        ...
        **ReLUs have the desirable property that they don't require input normalization to prevent them from saturating.**    
        ...
        (입력의 normalization이 필요 없어짐, 여러 feature map 에서의 결과를 normalization 해주면 lateral inhibition(측면 억제)이 발생 (generalization 관점에서 훨씬 좋다.))
