...
- ## Overview    
    ...
    ![AlexNet Structure](/assets/img/alexnet_structure.jpg)    
...
- ## Section 3. Architecture
    ...
    - ### ReLU Nonlinearity
        ...
        - #### 훈련 시간 관점 with gradient descent 
            ...
            - 왜 학습 속도가 빠를까?   
                ...
                ![ReLUs vs tanh](/assets/img/reluVStanh.jpg)
        ...
        **ReLUs have the desirable property that they don't require input normalization to prevent them from saturating.**    
        ...
        - [참고]    
            ...
            [해결]            
        ![bn question](/assets/img/BN_question.png)    
    ...
    - ### Local Response Normalization (LRN)
        ...
        - 여기서 나온 scheme은 local contrast normalization scheme [\[11\]](http://yann.lecun.com/exdb/publish/pdf/jarrett-iccv-09.pdf)과 유사   
