...
- ## Overview    
    ...
    ![AlexNet Structure](/assets/images/alexnet_structure.jpg)    
...
- ## INTRODUCTION    
    ...
    - 물체 인식에서 strong & correct assumption이 되기 위한 조건    
        ...
        2. [**stationarity of statistics**]({% link deep learning/_posts/2020-08-26-stationarity-of-statistics.md %}) (이해가 잘 안됨. 픽셀의 변함이 없어야한다. 어떤게?)   
        3. [**locality of pixel dependencies**]({% link deep learning/_posts/2020-08-26-stationarity-of-statistics.md %})      
            
        이 세 가지를 [the nature of images]({% link deep learning/_posts/2020-08-26-stationarity-of-statistics.md %}) 라고 부르고, 이를 만족하면 strong & correct assumption을 할 수 있다고 말할 수 있다.
...
- ## Section 3. Architecture
    ...
    - ### ReLU Nonlinearity
        ...
        - #### 훈련 시간 관점 with gradient descent 
            ...
            - 왜 학습 속도가 빠를까?   
                ...
                ![ReLUs vs tanh](/assets/images/reluVStanh.jpg)
        ...
        **ReLUs have the desirable property that they don't require input normalization to prevent them from saturating.**    
        ...
        - [참고]    
            ...
            [해결]            
        ![bn question](/assets/images/BN_question.png)    
    ...
    - ### Local Response Normalization (LRN)
        ...
        - 요즘은 이거 안쓰고 batch normalization 사용
          - [왜 LRN 안쓰고 BN 사용할까?]({% link deep learning/_posts/2020-08-31-Local-Response-Normalization.md %})
