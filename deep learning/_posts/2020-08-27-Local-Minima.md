...
- Local Min, Max vs Global Min, Max    
    ![local global](/assets/images/local_global.jpg)
...
- Stationary Point(Critical Point) (정상점)   
    ![Stationary Point](/assets/images/stationary_points.jpg)  
...
- Saddle Point (안정점)
    ...
    ![Saddle Point](/assets/images/saddle_point.jpg)   
    ...
    ![Saddle Point](/assets/images/saddle_matlab.jpg)           
...
- Flat Minima VS Sharp Minima    
    ...
    ![sharp minima](/assets/images/sharp_minima.jpg)    

    - Sharpness Definition
    ![sharpness](/assets/images/sharpness.jpg)
