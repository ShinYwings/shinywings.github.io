...
[AlexNet]({% link deep learning/_posts/2020-08-23-AlexNet.md %}) 논문 중에서,    
...
- locality of pixel dependencies    
    ...
    ![locality](/assets/images/locality_of_pixel_dependency.png)    
...
- **궁금한 점**:    
    ...
    ![stationarity of statistics vs locality of pixel dependency](/assets/images/stationarity_of_statistics.png)     
...
- 그럼 연산과정에서 이미지의 모든 위치에서 (어느 특징을 담은)filter를 공유할 수 있어야 겠네?         
    ...
    마찬가지로, [CONV vs CORR]({% link deep learning/_posts/2020-08-27-Correlation-vs-Convolution.md %}) 에서 본 것처럼 프레임 워크가 Convolution을 쓰는지 Cross-Correlation 쓰는지 동일한 효과를 내기 때문에 프레임워크 마다 서로 다르다고 한다.     
...
![translation_invariance](/assets/images/translation_invariant.png)    
